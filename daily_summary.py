...
Fetches recent headlines, asks Claude Code to summarize them in 1-2 sentences.
"""
...
def create_prompt(articles):
    ...
    prompt = "Please read these recent Russian media articles and write a 1-2 sentence summary of the main themes:\n\n"
...
def main():
    print("=" * 60)
    print("RUSSIAN MEDIA DAILY SUMMARY")
    print("=" * 60)
    print()
    ...
    prompt_file = Path("data/prompt.txt")
    with open(prompt_file, 'w', encoding='utf-8') as f:
        f.write(prompt)

    print(f"📝 Created prompt with {len(articles)} articles")
    ...
    print("=" * 60)
    print()
    print("Run this command to generate summary:")
    print()
    print(f'  claude code --print "$(cat data/prompt.txt)"')
    print()
    print("Then paste the summary when prompted by automation script.")
    print()
