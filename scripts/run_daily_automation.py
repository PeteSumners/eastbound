...
def main():
    ...
    print("\n" + "="*60)
    print("STEP: Verify content generation")
    print("="*60)
    ...
    if not drafts:
        ...
        print("[INFO] Draft should be created by external automation (run_automation_with_claude.ps1)")
        print(f"[INFO] Expected: content/drafts/{date}-analysis.md")
        print("\n[FALLBACK] You can manually create the draft and re-run this script")
        return 1
